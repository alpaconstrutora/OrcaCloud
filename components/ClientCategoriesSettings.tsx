...
function renderCategoryCell(
    ...
    const { cat, editingId, editValue, setEditValue, handleUpdate, cancelEdit } = ctx;
    switch (key) {
        case 'name':
            return editingId === cat.id ? (
                <div className="flex items-center gap-2">
                    <input
                        ...
                        className="flex-1 h-8 px-2 rounded-[6px] border border-gray-200 text-sm font-normal focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all"
...
const ClientCategoriesSettings: React.FC = () => {
    ...
    const [searchTerm, setSearchTerm] = usePersistedState<string>('clientCategories:search', '');
    ...
    return (
        <div className="bg-white rounded-[10px] shadow-sm border border-gray-100 p-6">
            ...
            <div className="mt-6 border-t border-gray-100 pt-6">
                {isAdding && (
                    <div className="flex items-center gap-2 p-2 mb-3 border border-blue-200 rounded-[10px] bg-blue-50/50">
                        <input
                            autoFocus
                            type="text"
                            value={editValue}
                            ...
                            className="flex-1 h-9 px-3 rounded-[6px] border border-gray-200 text-sm font-normal focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all"
                ...
                {/* Toolbar acoplada à tabela (§5.2) — mesmo padrão de OpuraDocsModule.tsx */}
