                                ...
                                {filteredDeals.map(deal => {
                                    ...
                                    return (
                                        <div key={deal.id} className="bg-white p-10 rounded-[2.5rem] border border-gray-200 shadow-xl shadow-gray-200/20 relative group hover:border-blue-200 transition-colors">
                                            ...
                                            <div className="mb-8">
                                                <span className={`text-xs font-black px-3 py-1 rounded-lg uppercase tracking-widest mb-2 inline-block ${deal.type === 'SALE' ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/20' : deal.type === 'RENTAL' ? 'bg-purple-600 text-white shadow-lg shadow-purple-600/20' : 'bg-amber-600 text-white shadow-lg shadow-amber-600/20'}`}>
                                ...
                                <table className="w-full text-left border-collapse">
                                    <thead className="bg-gray-50 border-b border-gray-100 italic">
                                        <tr>
                                            ...
                                            <th className="px-8 py-6 text-xs font-black text-gray-400 uppercase tracking-[0.2em]">Obra Vinculada</th>
                                            ...
                                            <th className="px-8 py-6 text-xs font-black text-gray-400 uppercase tracking-[0.2em]">Nº Contrato</th>
                            ...
                            {[
                                ...
                                <div key={i} className="bg-white p-8 rounded-[2.5rem] border border-gray-200 shadow-xl shadow-gray-200/20 hover:scale-105 transition-transform duration-500">
                                    ...
                                    <div className="mt-4 flex items-center gap-2">
                                        <span className="text-xs font-black text-emerald-500 bg-emerald-500/10 px-2 py-0.5 rounded">+12.5%</span>
