        ...
        <div className="space-y-4">
            ...
            {loadingDue ? (
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5 space-y-3">
                    ...
                    <div className="space-y-2">
                        {dueContracts.map(c => (
                            <div key={c.id} className="flex items-center justify-between gap-3 bg-white rounded-xl px-4 py-2.5">
                                <div className="flex-1 min-w-0">
                                    <p className="text-sm font-medium text-gray-900 truncate">{c.number} — {c.title}</p>
