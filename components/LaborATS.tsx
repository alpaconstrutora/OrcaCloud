                    ...
                    <div className="flex items-center gap-2">
                        {!editing ? (
                            ...
                            <>
                                ...
                                <button onClick={handleSaveEdit} disabled={saving} className="flex items-center gap-1 px-3 py-1.5 text-button font-bold text-white bg-indigo-600 hover:bg-indigo-700 rounded-xl disabled:opacity-50">
