...
import { X, TrendingUp, Ruler, LayoutGrid, ShieldCheck, ArrowRight, Info, BrainCircuit } from 'lucide-react';
import { RentalPricingConfig } from '../types';
import Button from './ui/Button';

interface RentalPricingIntelligenceModalProps {
    isOpen: boolean;
    onClose: () => void;
...
const RentalPricingIntelligenceModal: React.FC<RentalPricingIntelligenceModalProps> = ({ isOpen, onClose, onApply, buildingName }) => {
...
export default RentalPricingIntelligenceModal;
