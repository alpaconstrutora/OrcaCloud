        ...
        <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-8">
            <div className="flex items-center justify-between">
                <div className="flex flex-col">
                    <span className="text-xs font-black text-gray-400 uppercase tracking-widest mb-1">Seu Repu-Score</span>
            ...
            <div className="pt-6 border-t border-gray-50 flex items-center gap-3">
                ...
                <p className="text-xs font-black text-gray-500 uppercase tracking-tight leading-tight">
