...
const ROTULO_INCLUIR: Record<keyof InclusaoNoConjunto, string> = { indice: 'Índice', plantas: 'Plantas por pavimento', eletrica: 'Elétrica (+ quadro de cargas e unifilar)', cortes: 'Cortes', elevacoes: 'Fachadas', ampliacoes: 'Ampliações (banheiros e cozinhas)', tabelas: 'Quadro de áreas e esquadrias' };
const ROTULO_TIPO = { INDICE: 'Índice', PLANTA: 'Planta', ELETRICA: 'Elétrica', QUADRO_DE_CARGAS: 'Quadro', UNIFILAR: 'Unifilar', CORTE: 'Corte', ELEVACAO: 'Fachada', AMPLIACAO: 'Ampliação', TABELAS: 'Tabelas' } as const;
