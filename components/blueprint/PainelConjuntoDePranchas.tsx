...
const ROTULO_INCLUIR: Record<keyof InclusaoNoConjunto, string> = { indice: 'Índice', plantas: 'Plantas por pavimento', humanizada: 'Plantas humanizadas (venda)', eletrica: 'Elétrica (+ quadro de cargas e unifilar)', cortes: 'Cortes', elevacoes: 'Fachadas', ampliacoes: 'Ampliações (banheiros e cozinhas)', tabelas: 'Quadro de áreas e esquadrias', topografica: 'Planta topográfica do imóvel (malha de coordenadas e roteiro)', incra: 'Planta do imóvel no padrão INCRA (vértices do SIGEF e tipos de limite)' };
const ROTULO_TIPO = { INDICE: 'Índice', PLANTA: 'Planta', HUMANIZADA: 'Humanizada', ELETRICA: 'Elétrica', QUADRO_DE_CARGAS: 'Quadro', UNIFILAR: 'Unifilar', CORTE: 'Corte', ELEVACAO: 'Fachada', AMPLIACAO: 'Ampliação', TABELAS: 'Tabelas', TOPOGRAFICA: 'Topográfica', INCRA: 'INCRA' } as const;
