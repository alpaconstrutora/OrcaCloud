                ...
                <div className="px-8 py-5 bg-gray-50/50 border-b border-gray-100">
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-3 items-end">
                        ...
                        <button
                            onClick={handleAdd}
                            disabled={saving}
                            className="flex items-center justify-center gap-1 px-3 py-2 bg-blue-600 text-white rounded-lg text-xs font-bold hover:bg-blue-700 disabled:opacity-60"
                        >
                    ...
                    <input
                        ...
                        className="mt-3 w-full px-3 py-1.5 border border-gray-200 rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-blue-500"
                            ...
                            <tbody className="divide-y divide-gray-50">
                                {items.map(item => (
                                    <tr key={item.id} className="hover:bg-gray-50/50 transition-colors group">
                                        ...
                                        <td className="px-6 py-3 text-xs text-gray-500">{TYPE_OPTIONS.find(o => o.value === item.type)?.label}</td>
                                        <td className="px-6 py-3 text-xs text-gray-500">{item.due_date ? new Date(item.due_date + 'T00:00:00').toLocaleDateString('pt-BR') : '—'}</td>
