                    ...
                    <div className="relative" ref={overflowRef}>
                        ...
                        {overflowOpen && (
                            <div className="absolute right-0 top-full mt-2 w-52 bg-white rounded-xl shadow-xl border border-gray-100 py-1.5 z-50 animate-in fade-in slide-in-from-top-2 duration-150">
                                ...
                                {/* Configurações */}
                                <Button variant="ghost" onClick={() => { setIsConfigModalOpen(true); closeOverflow(); }} className="w-full justify-start rounded-none px-4 py-2 text-gray-600 hover:bg-gray-50">
