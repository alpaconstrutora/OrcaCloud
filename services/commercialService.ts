...
export const commercialService = {
    async listProperties(organizationId?: string, projectId?: string, purpose?: 'SALE' | 'RENTAL' | 'BOTH') {
        ...
        let query = supabase
            ...
            .select('id, organization_id, project_id, parent_id, client_id, name, type, purpose, address, area, private_area, common_area, total_area, price, initial_price, table_price, status, specs, block, floor, typology, position_type, view_type, sun_orientation, features, images, created_at, updated_at')
