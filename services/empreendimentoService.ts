...
const TOWER_COLS = 'id, empreendimento_id, project_id, imovib_block_id, planta_ai_scenario_id, blueprint_quadra_uid, name, floors_count, units_per_floor, construction_cost_sqm, sales_price_sqm, sort_order, created_at, updated_at';

const FLOOR_COLS = 'id, tower_id, name, tipo, floor_number, repeat_count, units_per_floor, prefix, sort_order, created_at, updated_at';

const UNIT_COLS = 'id, tower_id, floor_id, floor_tipo, imovib_unit_id, imovib_instance_id, planta_ai_unit_id, blueprint_lote_uid, quadra, lote, testada_m, confrontantes, name, floor, typology, private_area, common_area, total_area, bedrooms, bathrooms, suites, parking_spaces, position_type, sun_orientation, view_type, price, status, rental_price, rental_status, is_vendavel, commercial_property_id, rental_property_id, sort_order, fracao_ideal_decimal, fracao_ideal_thousandths, fracao_ideal_origem, fracao_ideal_fonte, fracao_ideal_transcrita_em, area_real_total_m2, area_engine_version_id, area_engine_synced_at, created_at, updated_at';
