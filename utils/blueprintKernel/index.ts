...
export { buildArrangement, recomputeSpaces, vertexDegrees, encostosSemJuncao, cantosEncostados } from './arrangement';
export type { EncostoSemJuncao, CantoEncostado } from './arrangement';
