...
export function lerPadraoOpura(
  ...
  const resumo: LeituraOpura['resumo'] = { portas: 0, janelas: 0, vaos: 0, arcosSemParede: 0, tocosDeBatente: 0, encostadas: 0, pontasSoltas: 0, cantosFechados: 0, arcosSemVao: 0, portasNoCanto: 0, janelasPeloSimbolo: 0, simbolosDeJanelaIgnorados: 0, vaosLargosDemais: 0, camadas: [], correr: 0, ambientes: 0, esquadriasSemParede: 0, esquadriasForaDaParede: 0 };
